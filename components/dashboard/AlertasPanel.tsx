...
interface AlertaCxC    { id: string; cliente: string; monto_pendiente: number; fecha_vence?: string }
          ...
          <SeccionAlerta icon="💳" titulo="Créditos vencidos (CxC)" color="#dc2626" count={alertas.cxcVencidas.length}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
              ...
              <div style={{ fontSize: 11, color: '#dc2626', marginTop: 4, fontWeight: 700 }}>
                Total vencido: {fmtUSD(alertas.cxcVencidas.reduce((a, c) => a + c.monto_pendiente, 0))}
              </div>
            </div>
          </SeccionAlerta>
        )}
